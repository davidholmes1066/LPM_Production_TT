...
def init_tt(com):
    xmega = s.Serial(com, 115200, bytesize=8, timeout=1, stopbits=serial.STOPBITS_ONE)      # Generate serial object xmega
...
def read_float(xmega):
    data = xmega.read(4)
    fdata = struct.unpack("f", data)
